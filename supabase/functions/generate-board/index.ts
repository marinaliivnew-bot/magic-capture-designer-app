...
Для каждого блока:
- caption: развёрнутое описание (2-4 предложения) визуального направления
- search_queries: 2-3 поисковых запроса на английском для поиска референсных изображений (для Pinterest/Unsplash)
